...
import { ExternalLink, AlarmClock, LinkIcon, AlertTriangle, X, Circle, Upload, Download, Trash2 } from "lucide-react"
...
export default function PredefinedPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      <div>
        <Sidebar activePage="predefined" />
      </div>

      <div className="flex-1 p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-[56rem]">
          <h1 className="mb-6 text-3xl font-bold tracking-tight">Predefined</h1>
          ...
          <Card className="mb-6 overflow-hidden">
            <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-3">
              <div>
                ...
                <CardDescription>
                  Insert one or multiple keywords here, and as soon as any are found on the web page, Auto Refresh Plus
                  will begin auto page refreshing at the default interval frequency.
                </CardDescription>
              </div>
              <Switch id="predefined-text" checked={predefinedText} onCheckedChange={setPredefinedText} />
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                ...
                <div
                  className={`flex flex-wrap items-center gap-2 p-2 border rounded-md ${
                    !predefinedText ? "bg-gray-50 dark:bg-gray-800/50 cursor-not-allowed" : "bg-white dark:bg-gray-900"
                  } ${inputValue && predefinedText ? "ring-2 ring-red-300 dark:ring-red-700/40" : ""}`}
                  onClick={focusInput}
                >
          ...
          <Card className="mb-6 overflow-hidden">
            <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-3">
              <div>
                ...
                <CardDescription>
                  Enter a specific URL here to refresh this URL, rather than the current tab you're using. So, for
                  example, if you save Google.com into the settings and then start the auto-refresh while on Yahoo.com,
                  Google.com will be refreshing, rather than the page you're looking at.
                </CardDescription>
              </div>
              <Switch id="predefined-url" checked={predefinedUrl} onCheckedChange={setPredefinedUrl} />
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-1 text-sm text-amber-700 dark:text-amber-400">
                          <p>
                            Enabling the "Refresh Predefined URL" feature will limit all auto-refresh functions to the
                            specified URL only that you write in this input. You will not be able to refresh any other
                            URLs when this feature is active.{" "}
                            <a
                              href="#"
