...
import { ExternalLink, Clock, Shuffle, Eye, Compass, Link, MousePointer, Crown } from "lucide-react"
...
export default function TimeIntervalPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      <div>
        <Sidebar activePage="time-interval" />
      </div>

      <div className="flex-1 p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-[56rem]">
          <h1 className="mb-6 text-3xl font-bold tracking-tight">Time Interval</h1>
          ...
          <Card className="mb-6 overflow-hidden">
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Set the default time for every page refresh. You can select either the predefined time intervals or
                provide your custom time interval from the extension popup.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-2">(Minimum 0.10 Sec)</p>
            </CardContent>
          </Card>
            ...
            <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-3">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <CardTitle className="text-xl">Enable Random Interval</CardTitle>
                </div>
                <CardDescription>
                  Randomize the time interval of each page refresh that Auto Refresh Plus makes. All that you need to do
                  is choose a minimum and maximum time duration, and the extension will perform automatic page refreshes
                  between the defined range.
                </CardDescription>
              </div>
              <Switch id="random-interval" checked={randomInterval} onCheckedChange={setRandomInterval} />
            </CardHeader>
            <CardContent>
              {randomInterval && (
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <CardTitle className="text-xl">Enable Visual Timer by Default</CardTitle>
                    <Badge
                      variant="outline"
                ...
                <CardDescription>
                  By default, enable visual timer for all pages you will refresh. If disabled, you can enable this
                  feature individually from the extension popup.
                </CardDescription>
              </div>
              <Switch
                id="visual-timer"
          ...
          <Card className="mb-6 overflow-hidden">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3 mb-4">
                ...
                <CardTitle className="text-xl">Visual Timer Position Control</CardTitle>
              </div>
              <CardDescription>
                Control where the visual timer appears on the page. Choose the display position that suits you best for
                showing the visual counter.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="mb-6 overflow-hidden">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3 mb-4">
                ...
                <CardTitle className="text-xl">URL Changes / Redirection Handling</CardTitle>
              </div>
              <CardDescription>
                If the website's URL changes while Auto Refresh Plus is running, it will automatically update to follow
                the new URL or stay on the original URL. This ensures that the page continues to refresh correctly
            ...
            <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-3">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <CardTitle className="text-xl">Stop Refresh on User Interaction</CardTitle>
                    <Badge
                      variant="outline"
                      className="bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950/50 dark:text-amber-400 dark:border-amber-800 flex items-center gap-1"
                    >
                ...
                <CardDescription>
                  Auto Refresh Plus will pause refreshing the page if you click the mouse or use the keyboard. Enable
                  this feature here for all websites, or enable it for individual pages/websites from the extension
                  popup.
                </CardDescription>
              </div>
              <Switch
                ...
                onCheckedChange={() => handlePremiumFeature("Stop Refresh on User Interaction")}
                className="cursor-pointer"
              />
            </CardHeader>
            <CardContent></CardContent>
      ...
      <PremiumFeatureDialog open={premiumDialogOpen} onOpenChange={setPremiumDialogOpen} featureName={currentFeature} />
    </div>
  )
}
