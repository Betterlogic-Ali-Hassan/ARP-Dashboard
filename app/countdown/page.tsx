...
export default function CountdownPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      <div>
        <Sidebar activePage="countdown" />
      </div>

      <div className="flex-1 p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-[56rem]">
          <h1 className="mb-6 text-3xl font-bold tracking-tight">Countdown</h1>
            ...
            <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-3">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <CardTitle className="text-xl">Enable Countdown Mode</CardTitle>
                </div>
                <CardDescription>
                  Perform a page refresh on a specific page after a certain amount of time has passed. Auto Refresh
                  Plus&apos;s countdown timer lets you do it. Simply enable and set the time, and the countdown timer
                  will begin. Once the countdown reaches zero, Auto Refresh Plus will begin refreshing the page again at
                  the set default intervals.
                </CardDescription>
              </div>
              <Switch id="countdown-mode" checked={countdownMode} onCheckedChange={handleCountdownModeChange} />
            </CardHeader>
            <CardContent>
              {countdownMode && (
                <>
                    ...
                    <div className="flex flex-row items-start justify-between">
                      <div>
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h3 className="text-lg font-medium">Countdown Timer</h3>
                        </div>
                        <p className="text-sm text-gray-500 dark:text-gray-400 ml-10">
                          The Countdown Timer in the Auto Refresh extension allows you to schedule a one-time page
                          refresh either after a set duration (e.g., 10 minutes) or at a specific date and time. This
                          feature is useful for situations where you want the page to reload at a precise moment or
                          after a countdown, rather than using regular refresh intervals.
                        </p>
                      </div>
                      <Switch
                        id="countdown-timer"
                    ...
                    <div className="flex flex-row items-start justify-between">
                      <div>
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h3 className="text-lg font-medium">Countdown Schedules</h3>
                        </div>
                        <p className="text-sm text-gray-500 dark:text-gray-400 ml-10">
                          Schedule Countdown lets you automatically start or stop refreshing a page at specific times on
                          selected days. You can create multiple schedules by choosing days and exact times, and
                          optionally enable features like auto-stop (to limit refresh duration) or auto-disable (to run
                          only once). It's ideal for setting up regular, timed page refreshes without manual input.
                        </p>
                      </div>
                      <Switch
