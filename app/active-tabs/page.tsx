...
export default function ActiveTabsPage() {
  ...
  const handleStopRefresh = (tabId: string) => {
    setActiveTabs((prevTabs) =>
      prevTabs.map((tab) =>
        tab.id === tabId ? { ...tab, interval: 0, nextRefresh: 0 } : tab
      )
    );
          ...
          <div className='mb-4 sm:mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4'>
            <div>
              ...
              <p className='text-gray-500 dark:text-gray-400 max-w-2xl text-sm'>
                View and control all actively refreshing tabs across your synced
            ...
            <div className='flex flex-row gap-2 sm:gap-3'>
              <Button
                ...
                className='whitespace-nowrap h-9 px-3 sm:px-4'
              >
                  ...
                  <div className='flex flex-wrap gap-2 sm:flex-1'>
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant='outline'
                          className='flex-shrink-0 h-9 text-sm'
                        >
                        ...
                        <DropdownMenuGroup>
                          ...
                          {profiles.map((profile) => (
                            <DropdownMenuItem
                              ...
                              className={
                                selectedProfile === profile.id ? "bg-muted" : ""
                              }
                            >
                              {profile.name}
                            </DropdownMenuItem>
                        ...
                        <DropdownMenuGroup>
                          ...
                          {devices.map((device) => (
                            <DropdownMenuItem
                              ...
                              className={
                                selectedDevice === device.id ? "bg-muted" : ""
                              }
                            >
                              {device.name}
                            </DropdownMenuItem>
                      ...
                      <DropdownMenuContent align='start' className='w-56'>
                        <DropdownMenuGroup>
                          ...
                          <DropdownMenuItem
                            ...
                            className={
                              selectedStatus === "refreshing" ? "bg-muted" : ""
                            }
                          >
                            Refreshing Only
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            ...
                            className={
                              selectedStatus === "monitor" ? "bg-muted" : ""
                            }
                          >
                            Monitor Enabled
                          </DropdownMenuItem>
              ...
              {filteredTabs.length > 0 ? (
                      ...
                      <TableBody>
                        {filteredTabs.map((tab) => (
                          <TableRow
                            ...
                            onClick={() =>
                              tab.keywordAlert && handleOpenAlertDialog(tab)
                            }
                          >
                              ...
                              {tab.keywordAlert && (
                                <Badge
                                  ...
                                  className={`flex items-center ${
                                    tab.alertType === "found"
                                      ? "animate-pulse bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-800"
                  ...
                  <div className='sm:hidden divide-y divide-gray-200 dark:divide-gray-800'>
                    {filteredTabs.map((tab) => (
                      <div
                        key={tab.id}
                        className={`p-4 ${
                          tab.keywordAlert ? "cursor-pointer" : ""
                        }`}
                        onClick={() =>
                          tab.keywordAlert && handleOpenAlertDialog(tab)
                        }
                ...
                <div className='flex flex-col items-center justify-center py-8 md:py-12 text-center px-4'>
                  ...
                  <p className='text-sm text-gray-500 dark:text-gray-400 max-w-md mb-6'>
                    No active tabs found across your devices. Tabs will appear
                    here when they are actively refreshing or being monitored.
                  </p>
                </div>
              )}
            </CardContent>
          ...
          >
            <DialogContent className='sm:max-w-[425px] p-5 sm:p-6'>
              ...
              <DialogFooter className='flex-col sm:flex-row gap-2 sm:gap-0 mt-4 sm:mt-0'>
                ...
                <Button
                  variant={
                    confirmDialog.action === "stop" ? "default" : "destructive"
                  }
                  onClick={() =>
                    confirmDialog.action === "stop"
                ...
                <div className='flex-1 p-4 sm:p-5 md:p-6 space-y-3 sm:space-y-4'>
                  ...
                  <div className='flex flex-wrap items-center gap-2'>
                    ...
                    <span className='text-gray-500 text-sm'>
                      •{" "}
                      {alertDialog.tab?.alertDetails &&
                        formatTimestamp(alertDialog.tab.alertDetails.timestamp)}
                    </span>
                  </div>
                  ...
                  <div className='flex flex-wrap items-center gap-2'>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {alertDialog.tab?.alertDetails?.keywords.map(
                        (keyword, index) => (
                          <Badge
                            key={index}
                            className={
                  ...
                  {alertDialog.tab?.alertDetails?.screenshot && (
                    <div className='space-y-2'>
                      ...
                      <p className='text-xs text-gray-500'>
                        ...
                        {formatTimestamp(
                          alertDialog.tab.alertDetails.timestamp
                        )}
                      </p>
                    </div>
                  )}
                  ...
                  <div className='flex flex-col-reverse sm:flex-row sm:justify-end gap-2 sm:gap-3 pt-2'>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        alertDialog.tab &&
                        handleVisitWebsite(alertDialog.tab.url)
                      }
                    >
