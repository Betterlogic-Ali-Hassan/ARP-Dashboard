        ...
        <div className='mx-auto max-w-[56rem]'>
          ...
          <Card className='mb-6 overflow-hidden'>
            <CardHeader className='flex flex-row items-start justify-between space-y-0 pb-3'>
              <div>
                ...
                <CardDescription>
                  Add default monitoring keywords here. You can also add custom
                  keywords for each website from the extension popup.
                </CardDescription>
              </div>
              <Switch
                id='default-target-text'
                checked={defaultTargetText}
                onCheckedChange={setDefaultTargetText}
              />
            </CardHeader>
            <CardContent>
              <div className='space-y-2'>
                ...
                <div
                  className={`flex flex-wrap items-center gap-2 p-2 border rounded-md ${
                    ...
                    inputValue && defaultTargetText
                      ? "ring-2 ring-red-300 dark:ring-red-800/30"
                      : ""
                  }`}
                  onClick={focusInput}
                >
          ...
          <Card className='mb-6 overflow-hidden'>
            <CardHeader className='pb-3'>
              ...
              <CardDescription>
                Automatically get notified when any given webpage has found or
                lost your defined keyword.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                >
                  ...
                  <p className='text-sm text-gray-500 dark:text-gray-400'>
                    Triggers a popup as soon as the defined text or pattern
                    appears on the page.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className='text-sm text-gray-500 dark:text-gray-400'>
                    Triggers a popup when the defined text or pattern disappears
                    from the page.
                  </p>
                </div>
              </div>
          ...
          <Card className='mb-6 overflow-hidden'>
            <CardHeader className='flex flex-row items-start justify-between space-y-0 pb-3'>
              <div>
                ...
                <CardDescription>
                  Auto Refresh Plus will continue to refresh the page even if it
                  finds or loses the monitored keyword. It will still trigger a
                  notification, email, or bell depending on your page
                  monitor&apos;s settings.
                </CardDescription>
              </div>
              <Switch
                checked={continueRefreshing}
                onCheckedChange={setContinueRefreshing}
              />
            </CardHeader>
            ...
            <CardHeader className='flex flex-row items-start justify-between space-y-0 pb-3'>
              <div>
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <CardTitle className='text-xl'>
                    Scroll to Keyword Location
                  </CardTitle>
                </div>
                <CardDescription>
                  Automatically scroll the page to the location of the specified
                  keyword when it is found.
                </CardDescription>
              </div>
              <Switch
                checked={scrollToKeyword}
                onCheckedChange={setScrollToKeyword}
              />
            </CardHeader>
            <CardContent></CardContent>
          </Card>
            ...
            <CardHeader className='flex flex-row items-start justify-between space-y-0 pb-3'>
              <div>
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <CardTitle className='text-xl'>
                    Enable Window Focus on Keyword Detection
                  </CardTitle>
                </div>
                <CardDescription>
                  Enable window focus when Page Monitor finds or loses a
                  keyword. This feature ensures that the window automatically
                  comes to the forefront of your screen whenever the specified
                  keyword is detected or lost.
                </CardDescription>
              </div>
              <Switch
                checked={enableWindowFocus}
                onCheckedChange={setEnableWindowFocus}
              />
            </CardHeader>
            <CardContent></CardContent>
          </Card>
            ...
            <CardHeader className='flex flex-row items-start justify-between space-y-0 pb-3'>
              <div>
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <CardTitle className='text-xl'>
                    Show Alert Tabs in Extension Popup
                  </CardTitle>
                </div>
                <CardDescription>
                  Show alert tabs in the extension popup to see any updates or
                  changes made by the page monitor. This feature provides a
                  convenient way to stay informed, especially when you have many
                  tabs open.
                </CardDescription>
              </div>
              <Switch
                checked={showAlertTabs}
                onCheckedChange={setShowAlertTabs}
              />
            </CardHeader>
            {showAlertTabs && (
                ...
                <div className='space-y-6'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-500 dark:text-gray-400 ml-10 mb-4'>
                      Select the time duration to retain the record of Alerted
                      Tabs before they automatically disappear.
                    </p>
                    <div className='ml-10 max-w-xs'>
                      <Select
                        value={retainDuration}
                        onValueChange={setRetainDuration}
                      >
