...
type ExecutionTiming = "url_opens" | "page_refresh" | "monitor_finds_text" | "monitor_loses_text" | "any_change"
...
export default function CustomScriptsPage() {
  ...
  const [scriptUrlMode, setScriptUrlMode] = useState<"whitelist" | "blacklist">("whitelist")
  const [scriptCode, setScriptCode] = useState("")
  const [scriptTiming, setScriptTiming] = useState<ExecutionTiming>("url_opens")
  const [scriptInjection, setScriptInjection] = useState<"before" | "after">("after")
  ...
  const debouncedSearch = useCallback(
    debounce((query: string) => {
      ...
      const filtered = scripts.filter(
        (script) =>
          script.name.toLowerCase().includes(lowerCaseQuery) || script.targetUrl.toLowerCase().includes(lowerCaseQuery),
      )
  ...
  const handleToggleScript = (id: number) => {
    setScripts(scripts.map((script) => (script.id === id ? { ...script, enabled: !script.enabled } : script)))
  }
  ...
  const handleDeleteScript = (id: number) => {
    ...
    setScriptMessage({ type: "success", message: "Script deleted successfully!" })
  ...
  const handleScriptSubmit = () => {
    ...
    setScriptMessage({
      type: "success",
      message: `Script ${editingScript !== null ? "updated" : "added"} successfully!`,
    })
  ...
  const handleExportScripts = () => {
    ...
    toast({
      ...
      description: `${scripts.length} script${scripts.length > 1 ? "s" : ""} exported to JSON file.`,
    })
  }
  ...
  const handleImportScripts = (event: React.ChangeEvent<HTMLInputElement> | React.DragEvent<HTMLDivElement>) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        if (Array.isArray(importedData)) {
          ...
          // Single script
          if ("name" in importedData && "targetUrl" in importedData && "code" in importedData) {
        ...
        toast({
          ...
          description: `${newScripts.length} script${newScripts.length > 1 ? "s" : ""} imported.`,
        })
      } catch (error) {
        toast({
    ...
    <div className="flex min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      ...
      <div className="flex-1 p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-[56rem]">
          <h1 className="mb-6 text-3xl font-bold tracking-tight">Custom Scripts</h1>
          ...
          <Card className="mb-6 overflow-hidden">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3 mb-4">
                ...
                <CardTitle className="text-xl">Execute Custom Scripts on the Page</CardTitle>
              </div>
              <CardDescription>
                If you love playing with automation, scraping, changing default website behavior, and have some basic
                knowledge of JavaScript, there's a lot you can do here.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="mb-6 overflow-hidden">
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Manage your custom JavaScript scripts that will be executed on specified web pages.
              </CardDescription>
            ...
            <CardContent>
              {scriptMessage.message && (
                ...
                >
                  {scriptMessage.type === "error" ? <AlertCircle className="h-4 w-4" /> : <Check className="h-4 w-4" />}
                  {scriptMessage.message}
                </div>
              )}
              ...
              <div className="space-y-4 mb-6">
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center justify-between p-4">
                      <div className="space-y-2 mb-3 md:mb-0">
                        <div className="flex items-center gap-2">
                          <span className="font-medium text-base">{script.name}</span>
                          <Badge variant={script.enabled ? "enabled" : "disabled"} className="text-xs border-0">
                ...
                {filteredScripts.length === 0 && searchQuery && (
                  <div className="flex flex-col items-center justify-center py-8 px-4 border border-dashed rounded-lg border-gray-300 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/30">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-1">No matching scripts found</p>
                ...
                {filteredScripts.length === 0 && !searchQuery && (
                  <div className="flex flex-col items-center justify-center py-8 px-4 border border-dashed rounded-lg border-gray-300 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/30">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-1">No scripts configured</p>
                    <p className="text-sm text-gray-400 dark:text-gray-500 mb-4">
              ...
              {showScriptForm ? (
                ...
                >
                  ...
                  <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <h4 className="font-medium text-lg">
                        {editingScript !== null ? "Edit Script" : "Add New Script"}
                      </h4>
                    </div>
                    {editingScript !== null && (
                      <Badge
                  ...
                  <div className="p-5 space-y-5">
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <Select
                          value={scriptUrlMode}
                          onValueChange={(value: "whitelist" | "blacklist") => setScriptUrlMode(value)}
                        >
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        Use * as a wildcard. Example: https://example.com/* will match all pages on example.com
                      </p>
                    </div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="grid gap-2">
                        <Label htmlFor="script-timing" className="text-sm font-medium flex items-center gap-2">
                          Execution Timing
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent className="max-w-xs">
                                <p>Choose when your script should execute on the page</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </Label>
                        <Select value={scriptTiming} onValueChange={(value: ExecutionTiming) => setScriptTiming(value)}>
                          <SelectTrigger id="script-timing">
                            <SelectValue placeholder="When to execute" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="url_opens">When URL Opens</SelectItem>
                            <SelectItem value="page_refresh">On Each Page Refresh</SelectItem>
                            <SelectItem value="monitor_finds_text">When Target Text Found</SelectItem>
                            <SelectItem value="monitor_loses_text">When Target Text Lost</SelectItem>
                            <SelectItem value="any_change">When Any Change Occurs</SelectItem>
                          </SelectContent>
                        </Select>

                        {(scriptTiming === "monitor_finds_text" || scriptTiming === "monitor_loses_text") && (
                      ...
                      <div className="grid gap-2">
                        <Label htmlFor="script-injection" className="text-sm font-medium flex items-center gap-2">
                          Injection Point
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger asChild>
                              ...
                              <TooltipContent className="max-w-xs">
                                <p>Choose when in the page lifecycle your script should be injected</p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                        </Label>
                        <Select
                          ...
                          onValueChange={(value: "before" | "after") => setScriptInjection(value)}
                        >
                          <SelectTrigger id="script-injection">
                            <SelectValue placeholder="Injection point" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="before">Before Page Load</SelectItem>
                            <SelectItem value="after">After Page Load</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-800 rounded-b-lg">
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      {editingScript !== null ? "Update your script settings" : "Configure your new script"}
                    </div>
                    <div className="flex items-center gap-2">
                      <Button
                        variant="outline"
                      ...
                      <Button
                        ...
                        disabled={!scriptName || !scriptTargetUrl || !scriptCode}
                        className={cn(
                          "transition-all",
                ...
                <div className="flex items-center gap-2">
                  <Button onClick={() => setShowScriptForm(true)} className="flex items-center gap-2">
                    <Plus className="h-4 w-4" />
                    Add New Script
                  </Button>
                  <Button
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40 p-6 rounded-lg border border-green-100 dark:border-green-900/30">
                <div className="flex flex-col mb-6">
                  ...
                  <p className="text-green-700/90 dark:text-green-400/90 mt-1">
                    Custom scripts can automate repetitive tasks and add new functionality to websites
                  </p>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                          Share your script ideas with our community. If your script benefits other users, we'll develop
                          it for free and publish it in our marketplace for everyone to use.
                        </p>
                        <div className="mt-4">
                          <Button
                            variant="outline"
                  ...
                  <div className="bg-white/80 dark:bg-gray-900/60 rounded-lg p-5 border border-emerald-100 dark:border-emerald-900/30 shadow-sm hover:shadow-md transition-shadow duration-200">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                          Need specialized automation for your business? Our team can develop custom scripts tailored to
                          your specific requirements, with pricing based on complexity and scope.
                        </p>
                        <div className="mt-4">
                          <Button
                            variant="outline"
          ...
          <Dialog open={importDialogOpen} onOpenChange={setImportDialogOpen}>
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>Upload a JSON file containing script configurations to import.</DialogDescription>
              </DialogHeader>
