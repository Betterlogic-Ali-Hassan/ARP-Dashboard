              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card className="relative overflow-hidden border-2 border-emerald-100 dark:border-emerald-900">
                  ...
                  <CardContent className="pb-6">
                    <div className="flex items-baseline mb-6">
                      ...
                      <span className="ml-1 text-gray-500 dark:text-gray-400 line-through text-sm">$3.99</span>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid gap-3">
                        ...
                        <div className="flex items-center">
                          <Check className="h-4 w-4 text-emerald-500 mr-2 flex-shrink-0" />
                          <span className="text-sm">Manage up to 3 devices (Non-Extendable)</span>
                        </div>
                        <div className="flex items-center">
                          <Check className="h-4 w-4 text-emerald-500 mr-2 flex-shrink-0" />
                          <span className="text-sm">Different settings profiles</span>
                        </div>
                        <div className="flex items-center">
                          <Check className="h-4 w-4 text-emerald-500 mr-2 flex-shrink-0" />
                          <span className="text-sm">Premium Support (72 hours)</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="relative overflow-hidden border-2 border-emerald-100 dark:border-emerald-900">
                  ...
                  <CardContent className="pb-6">
                    <div className="flex items-baseline mb-6">
                      ...
                      <span className="ml-1 text-gray-500 dark:text-gray-400 line-through text-sm">$9.99</span>
                      <span className="ml-1 text-gray-500 dark:text-gray-400 text-sm">/month</span>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid gap-3">
                        ...
                        <div className="flex items-center">
                          <Check className="h-4 w-4 text-emerald-500 mr-2 flex-shrink-0" />
                          <span className="text-sm">Manage up to 10 devices (Extendable)</span>
                        </div>
                        <div className="flex items-center">
                          <Check className="h-4 w-4 text-emerald-500 mr-2 flex-shrink-0" />
                          <span className="text-sm">Different settings profiles</span>
                        ...
                        <div className="flex items-center">
                          <Check className="h-4 w-4 text-emerald-500 mr-2 flex-shrink-0" />
                          <span className="text-sm">Premium Support (24 hours)</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="border-2 border-gray-100 dark:border-gray-800">
                  <CardHeader className="pb-8 pt-6">
                    ...
                    <CardDescription className="text-sm text-gray-500 dark:text-gray-400">
                      Suitable for casual users with limited features and support through self-service resources.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="pb-6">
                    <div className="flex items-baseline mb-6">
                ...
                <Card className="border-2 border-gray-100 dark:border-gray-800">
                  ...
                  <CardContent className="pb-6">
                    ...
                    <div className="mb-6">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">Always free</span>
                    </div>
