...
import { Check, Crown, ExternalLink, Users, BuildingIcon as Buildings, Gift } from "lucide-react"
...
import { PLANS, type PlanType, type BillingPeriodType, getYearlyDiscountPercentage } from "@/lib/plan-utils"
  ...
  const handleSubscriptionComplete = (success: boolean) => {
    ...
    if (success) {
      toast({
        ...
        description: "Your subscription has been activated. Enjoy your new features!",
      })
    ...
    <div className="flex min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-6xl">
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <p className="text-gray-500 dark:text-gray-400 max-w-2xl">
                Explore and choose from our available pricing plans to unlock additional features and increase device
                limits.
              </p>
              <Link
                href="#comparison"
          ...
          <Tabs defaultValue="yearly" className="mb-8" value={billingPeriod} onValueChange={setBillingPeriod}>
            ...
            <TabsContent value="yearly" className="mt-6">
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card className="relative overflow-hidden border-2 border-emerald-100 dark:border-emerald-900">
                  ...
                  <CardHeader className="pb-8 pt-6">
                    <div className="flex items-center mb-2">
                      <Crown className="h-6 w-6 mr-2" style={{ color: "#059669" }} />
                      <CardTitle className="text-xl">Individual</CardTitle>
                    </div>
                    <CardDescription className="text-sm text-gray-500 dark:text-gray-400">
                      Ideal for personal use with comprehensive premium features and reliable support.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="pb-6">
                    ...
                    <div className="mb-6">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">Billed yearly</span>
                    </div>

                    <div className="space-y-2">
                      <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-3">WHAT'S INCLUDED</h4>
                      <div className="grid gap-3">
                        {PLANS.individual.features.map((feature, index) => (
                          <div key={index} className="flex items-center">
                            <Check className="h-4 w-4 mr-2 flex-shrink-0" style={{ color: "#059669" }} />
                ...
                <Card className="relative overflow-hidden border-2 border-amber-100 dark:border-amber-900">
                  ...
                  <CardHeader className="pb-8 pt-6">
                    <div className="flex items-center mb-2">
                      <Users className="h-6 w-6 mr-2" style={{ color: "#F59E0B" }} />
                      <CardTitle className="text-xl">Team plan</CardTitle>
                    </div>
                    <CardDescription className="text-sm text-gray-500 dark:text-gray-400">
                      Perfect for teams and businesses, offering extended device management and priority support.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="pb-6">
                    <div className="flex items-baseline mb-6">
                      <span className="text-3xl font-bold">
                        {billingPeriod === "yearly" ? PLANS.team.pricing.yearlyPerMonth : PLANS.team.pricing.monthly}
                      </span>
                      {billingPeriod === "yearly" && (
                        <span className="ml-1 text-gray-500 dark:text-gray-400 line-through text-sm">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid gap-3">
                        {PLANS.team.features.map((feature, index) => (
                          <div key={index} className="flex items-center">
                            <Check className="h-4 w-4 mr-2 flex-shrink-0" style={{ color: "#F59E0B" }} />
                            <span className="text-sm">{feature}</span>
                          </div>
                        ))}
                      </div>
                ...
                <Card className="relative overflow-hidden border-2 border-purple-100 dark:border-purple-900">
                  ...
                  <CardHeader className="pb-8 pt-6">
                    ...
                    <CardDescription className="text-sm text-gray-500 dark:text-gray-400">
                      Comprehensive solution for large organizations with advanced requirements and dedicated support.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="pb-6">
                    <div className="flex items-baseline mb-6">
                    ...
                    <div className="mb-6">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">Billed monthly or yearly</span>
                    </div>
            ...
            <TabsContent value="monthly" className="mt-6">
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card className="relative overflow-hidden border-2 border-emerald-100 dark:border-emerald-900">
                  ...
                  <CardContent className="pb-6">
                    <div className="flex items-baseline mb-6">
                      <span className="text-3xl font-bold">{PLANS.individual.pricing.monthly}</span>
                      <span className="ml-1 text-gray-500 dark:text-gray-400 text-sm">/month</span>
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">Billed monthly</span>
                    </div>
                ...
                <Card className="relative overflow-hidden border-2 border-amber-100 dark:border-amber-900">
                  ...
                  <CardContent className="pb-6">
                    <div className="flex items-baseline mb-6">
                      <span className="text-3xl font-bold">{PLANS.team.pricing.monthly}</span>
                      <span className="ml-1 text-gray-500 dark:text-gray-400 text-sm">/month</span>
                    </div>
                ...
                <Card className="relative overflow-hidden border-2 border-purple-100 dark:border-purple-900">
                  ...
                  <CardContent className="pb-6">
                    <div className="flex items-baseline mb-6">
                      <span className="text-3xl font-bold">{PLANS.enterprise.pricing.monthly}</span>
                      <span className="ml-1 text-gray-500 dark:text-gray-400 text-sm">/month</span>
                    </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4 md:mb-0 max-w-2xl">
                    Get started with our free plan. Manage up to 3 devices with basic features and access to support
                    articles.
                  </p>
                  <div className="mt-4 flex flex-wrap gap-3">
                    <div className="flex items-center">
                      <Check className="h-4 w-4 text-blue-500 mr-2 flex-shrink-0" />
                      <span className="text-sm">Basic access with limited features</span>
                    </div>
                    <div className="flex items-center">
                      <Check className="h-4 w-4 text-blue-500 mr-2 flex-shrink-0" />
                    ...
                    <div className="flex items-center">
                      <Check className="h-4 w-4 text-blue-500 mr-2 flex-shrink-0" />
                      <span className="text-sm">Access to support articles</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                <h3 className="text-lg font-medium mb-2">How do I upgrade my subscription?</h3>
                <p className="text-gray-500 dark:text-gray-400">
                  You can upgrade your subscription at any time from your account settings. Your new plan will be
                  activated immediately, and you'll be charged the prorated amount for the remainder of your billing
                  cycle.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                <h3 className="text-lg font-medium mb-2">Can I downgrade my subscription?</h3>
                <p className="text-gray-500 dark:text-gray-400">
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Our 7-day free trial gives you full access to all features of the Individual plan. No credit card is
                  required to start. At the end of the trial, you can choose to subscribe or your account will
                  automatically revert to the Basic plan.
                </p>
              </div>
              <div className="bg-white dark:bg-gray-900 p-6 rounded-lg border border-gray-200 dark:border-gray-800">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                ...
                <p className="text-emerald-50 max-w-2xl">
                  Choose the plan that's right for you and start managing your devices with ease. All plans come with a
      ...
      <PlanChangeDialog
        ...
        devicesUsed={0} // New users have 0 devices
