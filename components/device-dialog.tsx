...
export function DeviceDialog({ open, onOpenChange, device, profiles, onSave }: DeviceDialogProps) {
  ...
  const [profileId, setProfileId] = useState(device?.profileId || profiles[0]?.id || "")
        ...
        {isEditing ? (
          ...
          <>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="px-6 pt-6 pb-0">
              <TabsList className="grid w-full grid-cols-2 mb-6">
                <TabsTrigger
                  value="general"
                  className={activeTab === "general" ? "border-b-2 border-emerald-500 rounded-none" : ""}
                >
                ...
                <TabsTrigger
                  value="information"
                  className={activeTab === "information" ? "border-b-2 border-emerald-500 rounded-none" : ""}
                >
              ...
              <TabsContent value="general" className="space-y-6 pb-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      The selected profile will determine the settings applied to this device.
                    </p>
                    ...
                    {profileId && (
                      <Button
                        ...
                        onClick={(e) => {
                          ...
                          window.open(`/settings-profiles?edit=${profileId}`, "_blank")
                        }}
                      >
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400">
                            Enable or disable settings synchronization with this device
                          </p>
                        </div>
                        <div className="flex items-center">
                          <Switch
                            ...
                            className={
                              autoConnect ? "data-[state=checked]:bg-emerald-500" : "data-[state=unchecked]:bg-red-500"
                            }
                          />
                          <span
                            className={`ml-2 text-sm ${
                              autoConnect ? "text-emerald-700 dark:text-emerald-400" : "text-red-700 dark:text-red-400"
                            }`}
                          >
                ...
                <div className="flex justify-end">
                  <Button onClick={goToNextTab} className="bg-emerald-500 hover:bg-emerald-600">
              ...
              <TabsContent value="information" className="space-y-6 pb-6">
                <div className="space-y-4">
                  ...
                  <div className="grid gap-2">
                    <Label className="text-sm font-medium">Connection History</Label>
                    <div className="rounded-md border border-gray-200 dark:border-gray-800 p-4 text-sm">
                      {device?.lastConnected ? (
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between">
                            <span className="text-gray-500 dark:text-gray-400">Connection count:</span>
                            <span>{Math.floor(Math.random() * 50) + 1}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-500 dark:text-gray-400">Average session:</span>
                            <span>{Math.floor(Math.random() * 120) + 10} minutes</span>
                          </div>
                        </div>
                      ) : (
                        <p className="text-gray-500 dark:text-gray-400">No connection history available</p>
                      )}
                    </div>
                  </div>

                  <div className="grid gap-2">
                    <Label className="text-sm font-medium">Device Identifier</Label>
                    <Input
                      disabled
                    ...
                    />
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      This is a unique identifier for your device and cannot be changed.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <Button onClick={handleSave} disabled={!isFormValid} className="bg-emerald-500 hover:bg-emerald-600">
          ...
          <>
            <DialogHeader className="p-6 pb-0">
              ...
              <DialogDescription>Follow these steps to connect a new device</DialogDescription>
            </DialogHeader>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-5 shadow-sm">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className={cn("min-w-[100px]", keyCopied && "bg-emerald-600 hover:bg-emerald-700")}
                    >
                      {keyCopied ? (
                        <>
                          <Check className="h-4 w-4 mr-2" />
                ...
                <div className="space-y-4">
                  <h3 className="font-medium text-base">How to connect your device</h3>
                  <div className="space-y-3">
                    <div className="flex gap-3">
                      ...
                      <p className="text-sm">
                        Install <span className="font-medium">Auto Refresh Plus</span> on your new device
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <p className="text-sm">
                        Open the app and select <span className="font-medium">"Connect to Master Device"</span>
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <p className="text-sm">Enter the sync key when prompted to connect devices</p>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <p className="text-sm">Settings will automatically sync between your devices</p>
                    </div>
                  </div>
                </div>
              </div>
