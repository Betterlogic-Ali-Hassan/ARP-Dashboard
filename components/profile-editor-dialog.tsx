...
export function ProfileEditorDialog({
  ...
  useEffect(() => {
    if (profile) {
      ...
      const associatedDeviceIds = devices
        .filter((device) => device.profileId === profile.id)
        ...
        <div className='bg-white dark:bg-gray-950 p-6 border-b border-gray-100 dark:border-gray-800'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-3'>
              <div
                className={`rounded-full bg-${themeColor}-100 dark:bg-${themeColor}-900/50 p-2`}
              >
                {isEditing ? (
        ...
        >
          <TabsList className='grid w-full grid-cols-2 mb-6'>
            <TabsTrigger
              ...
              className={
                activeTab === "general"
                  ? `border-b-2 border-${themeColor}-500 rounded-none`
                  : ""
              }
            >
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <p className='text-xs text-gray-500 dark:text-gray-400 mt-1'>
                  A good description helps you remember the purpose of this
                  profile.
                </p>
              </div>
          ...
          <TabsContent value='devices' className='space-y-6 pb-6'>
            <div className='space-y-4'>
                      ...
                      <div
                        ...
                        className={`flex items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-900 ${
                          selectedDevices.includes(device.id)
                            ? `bg-${themeColor}-50 dark:bg-${themeColor}-950/30`
                            : ""
              ...
              <div className='flex items-center gap-2 bg-gray-50 dark:bg-gray-900 rounded-lg p-4'>
                <div
                  className={`rounded-full p-1.5 bg-${themeColor}-100 dark:bg-${themeColor}-900/50`}
                >
