...
export function ImportSettingsDialog({ open, onOpenChange, profileName, onImport }: ImportSettingsDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Upload a JSON file containing settings to import into this profile.</DialogDescription>
        </DialogHeader>
        ...
        >
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium mb-1">Drag and drop your JSON file here</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">or click to browse</p>
            </div>
            <Button variant="outline" size="sm" onClick={handleBrowseClick} className="mt-2">
              Browse Files
            </Button>
          </div>
        ...
        <DialogFooter className="mt-4">
          ...
          <Button onClick={handleImport} disabled={!file} className="bg-emerald-600 hover:bg-emerald-700 text-white">
            Import Settings
          </Button>
        </DialogFooter>
      </DialogContent>
