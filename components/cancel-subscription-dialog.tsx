...
export function CancelSubscriptionDialog({ open, onOpenChange, onComplete }: CancelSubscriptionDialogProps) {
    ...
    >
      <DialogContent className="sm:max-w-[500px] w-[95vw] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            We're sorry to see you go. Please let us know why you're canceling your subscription.
          </DialogDescription>
        </DialogHeader>

        <div className="py-4 space-y-6">
          <div>
            <h3 className="text-sm font-medium mb-3">Reason for cancellation</h3>
            <RadioGroup value={reason} onValueChange={handleReasonChange} className="space-y-3">
          ...
          <div
            className={`grid gap-2 overflow-hidden transition-all duration-300 ease-in-out ${
              reason === "other" ? "max-h-[200px] opacity-100 my-6" : "max-h-0 opacity-0 my-0"
            }`}
          >
            {reason === "other" && (
              <>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-2">
              ...
              <div className="grid gap-1.5 leading-none">
                ...
                <p className="text-sm text-muted-foreground">Instead of waiting until the end of your billing period</p>
              </div>
            </div>
          </div>
