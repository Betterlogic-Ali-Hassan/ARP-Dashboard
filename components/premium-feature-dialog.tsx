...
export function PremiumFeatureDialog({
  ...
  const getPlanPrice = (plan: PlanType, period: BillingPeriodType) => {
    return period === "monthly" ? PLANS[plan].pricing.monthly : PLANS[plan].pricing.yearly
  }
  ...
  const handleBack = () => {
    ...
    else if (currentStep === "plan-summary" && selectedPlan === "individual" && !isLoggedIn) {
      setCurrentStep("email-collection")
    }
          ...
          >
            <div className="bg-white dark:bg-gray-800 p-4 sm:p-5">
              <div className="flex items-center mb-2">
                ...
                <h3 className="font-bold text-base sm:text-lg">{PLANS.individual.name}</h3>
              </div>
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4">Perfect for personal use</p>
          ...
          >
            ...
            <div className="bg-gradient-to-b from-amber-50 to-white dark:from-gray-800 dark:to-gray-900 p-4 sm:p-5">
              <div className="flex items-center mb-2">
                ...
                <h3 className="font-bold text-base sm:text-lg">{PLANS.team.name}</h3>
              </div>
              <div className="text-xl sm:text-2xl font-bold mb-1">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4">Great for small teams</p>

              <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm mb-3 sm:mb-4">
                <li className="flex items-start">
                  <Check className={`h-3.5 sm:h-4 w-3.5 sm:w-4 mr-1.5 sm:mr-2 mt-0.5 ${PLANS.team.color.badgeText}`} />
                  <span>Full access to all premium features</span>
                </li>
                <li className="flex items-start">
                  <Check className={`h-3.5 sm:h-4 w-3.5 sm:w-4 mr-1.5 sm:mr-2 mt-0.5 ${PLANS.team.color.badgeText}`} />
          ...
          >
            <div className="bg-white dark:bg-gray-800 p-4 sm:p-5">
              <div className="flex items-center mb-2">
                ...
                <h3 className="font-bold text-base sm:text-lg">{PLANS.enterprise.name}</h3>
              </div>
              <div className="text-xl sm:text-2xl font-bold mb-1">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4">For larger organizations</p>
    ...
    return (
      <div className="py-2">
        ...
        <div className="text-center mb-4 sm:mb-6">
          ...
          <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">Almost there!</h3>
          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
            Enter your email address to continue with your {planName} plan subscription.
          </p>
        </div>

        <div className="border rounded-lg overflow-hidden mb-4 sm:mb-6 shadow-sm">
          <div className={`p-3 sm:p-4 border-b bg-emerald-50 dark:bg-emerald-900/20`}>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
              ...
              <div className="sm:text-right">
                <div className={`text-lg sm:text-xl font-bold text-emerald-800 dark:text-emerald-300`}>{planPrice}</div>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex">
                ...
                <div className="ml-2 sm:ml-3">
                  <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-300 font-medium">
                    We will register your subscription under this email. Don't worry, you won't lose your progress.
                  </p>
                </div>
              </div>
            </div>
  ...
  const renderPlanSummary = () => {
    ...
    return (
      <div className="py-2">
        ...
        <div className="text-center mb-4 sm:mb-6">
          <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">Plan Change Summary</h3>
        ...
        <div className="border rounded-lg overflow-hidden mb-4 sm:mb-6 shadow-sm">
          <div className={`p-3 sm:p-4 border-b ${getBgColor()}`}>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
              <div className="mb-2 sm:mb-0">
                <h4 className={`font-bold text-sm sm:text-base ${getTextColor()}`}>{planName} Plan</h4>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                  {billingPeriod === "monthly" ? "Monthly" : "Annual"} billing
                </p>
              </div>
              <div className="sm:text-right">
                <div className={`text-lg sm:text-xl font-bold ${getTextColor()}`}>{planPrice}</div>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                  {billingPeriod === "monthly" ? "per month" : "per year"}
                </p>
              </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm font-medium text-blue-600 dark:text-blue-400">{email}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
          ...
          {billingPeriod === "yearly" && (
            <div className="flex justify-between items-center mb-1.5 sm:mb-2">
              <span className="text-xs sm:text-sm text-green-600 dark:text-green-400">Annual discount</span>
          ...
          <div className="border-t my-1.5 sm:my-2 pt-1.5 sm:pt-2">
            <div className="flex justify-between items-center">
              <span className="font-medium text-sm sm:text-base">Total due today</span>
              <span className="font-bold text-base sm:text-lg">{planPrice}</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start">
            ...
            <div className="flex-grow">
              ...
              <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-400">
                Payments securely processed by <span className="font-semibold">Stripe</span>. No card data stored on our
                servers.
              </p>
            </div>
          </div>
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[calc(100%-2rem)] sm:max-w-[600px] md:max-w-[700px] lg:max-w-[800px] p-0 overflow-hidden">
        {currentStep === "plan-selection" && (
          <div className="bg-gradient-to-b from-amber-50 to-amber-100 dark:from-amber-950/40 dark:to-amber-900/20 p-4 sm:p-6 text-center">
            ...
            <DialogTitle className="text-lg sm:text-2xl font-bold mb-1 sm:mb-2">Unlock Premium Features</DialogTitle>
            <DialogDescription className="text-sm sm:text-base max-w-md mx-auto">
              <span className="font-medium text-amber-700 dark:text-amber-300">{featureName}</span> is a premium
              feature. Upgrade to access all premium tools and enhance your experience.
            </DialogDescription>
          </div>
        )}

        <div className="p-4 sm:p-6 overflow-y-auto max-h-[750px] relative">
          {currentStep === "plan-selection"
            ? renderPlanSelection()
