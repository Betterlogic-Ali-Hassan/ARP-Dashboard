...
export function TicketChatPanel({
  ...
  const { sendMessage, getMessagesForTicket, updateTicketStatus } =
    useTicketStore();
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedImage) {
        ...
        const textContent = sanitizedMessage.trim()
          ? `${sanitizedMessage}\n${imageContent}`
          : imageContent;
  ...
  return (
    <div
      className={cn(
        ...
        isMobile
          ? "fixed inset-0 z-50"
          : "fixed top-0 right-0 mt-[64px] h-[calc(100vh-64px)] w-[350px] sm:w-[400px] lg:w-[450px] max-w-[50%] overflow-hidden"
      )}
    >
      {/* Header */}
            ...
            <div className='flex items-center gap-1.5 sm:gap-2'>
              {isMobile && (
                <Button
                  ...
                  size='icon'
                  onClick={onClose}
                  className='mr-0.5 -ml-1.5 h-8 w-8 sm:h-9 sm:w-9'
                >
              ...
              <>
                ...
                <div className='flex items-end gap-1.5 sm:gap-2'>
                  <div className='flex-1'>
                    ...
                    />
                    {fileError && (
                      <div className='mt-1 text-[10px] xs:text-xs text-red-500 dark:text-red-400'>
                        {fileError}
                      </div>
                    )}
                  </div>
                  <div className='flex flex-col gap-1.5 sm:gap-2'>
                    ...
                    <Button
                      ...
                      size='icon'
                      disabled={
                        (!message.trim() && !selectedImage) || isSubmitting
                      }
