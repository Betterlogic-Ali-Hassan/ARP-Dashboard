...
export function SubscriptionNotification({
  ...
  const handleDismiss = () => {
    ...
    toast({
      ...
      description:
        "You can still manage your subscription from the Account page.",
    });
  };
  ...
  const getNotificationContent = () => {
    if (status === "canceled") {
      return {
        ...
        description: `Your ${getPlanName(
          currentPlan ?? currentPlan
        )} plan will be canceled on ${expiryDate}.`,
      ...
      return {
        ...
        description: `Your plan will be downgraded from ${getPlanName(
          currentPlan
        )} to ${getPlanName(targetPlan || "basic")} on ${expiryDate}.`,
              ...
              {status === "canceled" ? (
                <>
                  ...
                  <span className='font-medium'>
                    {getPlanName(currentPlan && currentPlan)}
                  </span>{" "}
                ...
                <>
                  ...
                  to{" "}
                  <span className='font-medium'>
                    {getPlanName(targetPlan || "basic")}
                  </span>{" "}
                  on <span className='font-medium'>{expiryDate}</span>.
                </>
              )}
            </p>
          </div>
