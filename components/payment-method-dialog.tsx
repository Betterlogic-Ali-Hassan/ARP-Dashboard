...
export function PaymentMethodDialog({
  ...
  const getCardTypeIcon = () => {
    switch (cardType) {
      case "visa":
        return (
          <div className='text-blue-600 font-bold text-lg tracking-wider'>
            VISA
          </div>
        );
      case "mastercard":
    ...
    >
      <DialogContent className='sm:max-w-[500px]'>
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new payment method to your account. Your payment information
            is securely stored.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className='absolute w-full h-full backface-hidden rounded-xl rotate-y-180 bg-gradient-to-br from-gray-800 to-gray-900 text-white overflow-hidden'>
                ...
                <div className='p-6 pt-4'>
                  ...
                  <div className='text-xs opacity-70 text-center mt-8'>
                    For security, please enter the 3-digit code on the back of
                    your card.
                  </div>
                </div>
              </div>
          ...
          <div className='space-y-4 mt-6'>
            <div className='grid gap-2'>
              ...
              <div className='relative'>
                <Input
                  ...
                  onFocus={() =>
                    dispatch({ type: "SET_CARD_FOCUS", payload: "number" })
                  }
                  onBlur={() =>
                    dispatch({ type: "SET_CARD_FOCUS", payload: null })
                  }
            ...
            <div className='grid gap-2'>
              ...
              <Input
                ...
                onFocus={() =>
                  dispatch({ type: "SET_CARD_FOCUS", payload: "name" })
                }
                onBlur={() =>
                  dispatch({ type: "SET_CARD_FOCUS", payload: null })
                }
                ...
                <Input
                  ...
                  onChange={(e) =>
                    dispatch({
                      ...
                      payload: formatCardExpiry(e.target.value),
                    })
                  }
                  onFocus={() =>
                    dispatch({ type: "SET_CARD_FOCUS", payload: "expiry" })
                  }
                  onBlur={() =>
                    dispatch({ type: "SET_CARD_FOCUS", payload: null })
                  }
                ...
                <Input
                  ...
                  onChange={(e) =>
                    dispatch({
                      ...
                      payload: formatCardCvc(e.target.value),
                    })
                  }
                  onFocus={() =>
                    dispatch({ type: "SET_CARD_FOCUS", payload: "cvc" })
                  }
                  onBlur={() =>
                    dispatch({ type: "SET_CARD_FOCUS", payload: null })
                  }
